                                    ...
                                    echo '<td>'.$item['subject'].'</td>';
       								...
       								if ($marking[$count-1]==0){
       									...
       									if ($check == 0) {
       										...
       										echo '<td class="alt">' .
                              					...
                              					'<a href="'.base_url().'maketest/user/marked_result/'.$item['booklet_id'].'">結果を見る</a>'.
                              					'</td>';
       									}
       								}else{
                              		...
                              		if ($currentTime < $startTime){
                              			...
                              			echo '<td class="alt">' .
                              				 ...
                              				 echo '<td class="alt">
                                    	        <a href="'.base_url().'maketest/user/marking/'.$item['booklet_id'].'">採点する</a>
